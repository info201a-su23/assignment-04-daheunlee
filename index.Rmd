...
selected_states <- c("Mississippi", "Louisiana", "Georgia", "New York")

# Filter data for Black and White jail population rates
black_white_data <- prison_data %>%
  filter(state %in% selected_states) %>%
  select(year, black_jail_pop_rate, white_jail_pop_rate)

# Create the trends over time chart
ggplot(black_white_data, aes(x = year)) +
  geom_line(aes(y = black_jail_pop_rate, color = "Black")) +
  geom_line(aes(y = white_jail_pop_rate, color = "White")) +
  labs(title = "Trends in Jail Population Rates: Black vs. White",
       x = "Year",
